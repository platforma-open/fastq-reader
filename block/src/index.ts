...
export type FastqReaderBlockContract = BlockContract;
export type FastqReaderBlockOutputs  = BlockOutputs;
export type FastqReaderBlockData     = BlockData;
export const FastqReaderBlockPointer = BlockPointer;
